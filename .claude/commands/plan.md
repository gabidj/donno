...
2. **Naming conventions** - actual examples from the codebase (Services, Controllers, Models)
3. **Error handling patterns** - how errors are created and handled
4. **Service patterns** - how services are structured and used
5. **Test patterns** - Pest test file structure and assertion styles
